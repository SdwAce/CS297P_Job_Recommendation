var app = angular.module("RecommendationByFavorite",["ngStorage",'ngAnimate', 'ngSanitize', 'ui.bootstrap']);

app.controller("RecommendationController",function($http,$scope,$localStorage,$uibModal, $log, $document)
{
    ...
    $http({method:"Post",url:"http://localhost:8080/Job_Recommendation/recommend",data:request})
